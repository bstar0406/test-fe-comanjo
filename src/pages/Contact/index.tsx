...
const Contact = () => {
    return (
        <div className="flex items-center justify-center px-2 lg:px-0 w-full h-full py-40" >
            <div className='contact-box rounded bg-[#FFFFFF] p-10 text-left text-[#111D5E] z-10 border-2 py-16'>
                <div className='get-title mb-1 text-3xl font-bold'>Get In Touch</div>
                <div className='get-subtitle mb-5 text-[#111D5E]'>We are here for you. How can we help?</div>
                <div className='contact-bottom flex gap-10'>
                    <div className='right-box flex justify-between flex-col text-center'>
                        ...
                        <button className="submit-button rounded-3xl text-lg font-semibold bg-[#111D5E] text-[#ffffff] font-sm w-1/3 h-[38px]">Submit</button>
                    </div>
