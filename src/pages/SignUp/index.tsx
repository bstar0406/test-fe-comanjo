...
import ForCompany from "../../assets/images/company1.jpg";
import ForSeeker from "../../assets/images/job-seeker1.jpg";
import "./style.css"
const SignUp = () => {
    return (
        <div className="signUp-template flex rounded" style={{height: "90vh"}}>
            <div className='signUp-box py-14 px-14 text-[#111D5E] m-auto'>
                ...
                <div className='individual-group flex items-center justify-center gap-14'>
                    <Link to='/auth/signup/company'>
                        <div className='individual-box p-5 max-w-xs'>
                            <img className='h-24 rounded' src={ForCompany} alt="ForCompany" />
                            <div className='mt-5 text-xl font-semibold'>We are a Company, hiring Job Seeker</div>
                        </div>
                    </Link>
                    <Link to='/auth/signup/jobseeker'>
                        <div className='individual-box p-5 max-w-xs'>
                            <img className='h-24 rounded' src={ForSeeker} alt="ForCompany" />
